...
sf.world <- ne_countries(scale = "medium", returnclass = "sf")

#Only keep the columns in sf.world df that are relevant to this analysis (iso_a2, name_long, and geometry)
sf.world <- sf.world %>%
  select(iso_a2, name_long, geometry, continent)
